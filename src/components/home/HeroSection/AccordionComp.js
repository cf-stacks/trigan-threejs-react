...
const AccordionComp = () => {
  ...
  return (
    <div>
      ...
      <div className="accordion relative px-4 pb-[100px]">
        <ul>
          <Link href="/accordionSections/section1">
            ...
            >
              {Show ? (
                <span className="sliderTextTrue heading-hide">
                  Trigan Blockchain
                </span>
              ) : (
                <span className="sliderText">Trigan Blockchain</span>
              )}
              <div>
                <a href="#" className="sliderLink">
                  <h2>Trigan Blockchain</h2>
                  <p>
                    The first real-world relevant blockchain Designed as a
                    fairer more powerful solution to the needs of urban
                    communities. The foundation of our smart city operating
                    system.
                  </p>
                </a>
              </div>
          ...
          <Link href="/accordionSections/section2">
            ...
            >
              {Show ? (
                ...
                <span className="sliderText">Trigan Economy</span>
              )}
              <div>
                <a href="#" className="sliderLink">
                  <h2>Trigan Economy</h2>
                  <p>
                    The next step in community enablement.Imagine a caring
                    economy actively working for the success of everyone,
                    regardless of background - a system created to bring
                    external funding to real-world towns and cities everywhere.
                  </p>
                </a>
              </div>
            </li>
          ...
          <Link href="/accordionSections/section3">
            ...
            >
              {Show ? (
                <span className="sliderTextTrue">Trigan Smartest City</span>
              ) : (
                <span className="sliderText">Trigan Smartest City</span>
              )}
              <div>
                <a href="#" className="sliderLink">
                  <h2>Trigan Smartest City</h2>
                  <p>
                    Fact checked networks of sensors providing data and analysis
                    to the Trigan urban blockchain, empowering communities and
                    helping everyone to have a voice. The operating system for
                    smart cities.
                  </p>
                </a>
              </div>
          ...
          <Link href="/accordionSections/section4">
            ...
            >
              {Show ? (
                <span className="sliderTextTrue">Trigan Digital Twins</span>
              ) : (
                <span className="sliderText">Trigan Digital Twins</span>
              )}
              <div>
                <a href="#" className="sliderLink">
                  <h2>Trigan Digital Twins</h2>
                  <p>
                    A new community-centric approach to digital twins. Applying
                    data holistically to inform real-time community simulations.
                    This is Trigan’s answer to Metaverse, introducing new ways
                    to live, work and play virtually. Commuting should be a
