...
/> */}
      ...
      <section className="Imgpart_center mx-auto    items-center px-4 py-36 text-slate-100 2xl:max-w-3xl ">
        <Swiper
          ...
          className=" paragraphStyle  label__show__data m-auto mb-[8rem] h-[65vh]  w-[75vw] translate-y-[-8rem]  snap-y snap-mandatory flex-wrap   overflow-y-scroll scroll-smooth  rounded-md  px-5 py-2 text-lg  font-extralight max-[1200px]:h-[70vh] max-[768px]:h-[72vh] max-[768px]:translate-y-[-6rem] max-[500px]:h-[105%] max-[500px]:h-[80vh] max-[500px]:w-[100%] max-[500px]:translate-y-[-3rem] md:py-5 md:text-xl"
        >
          <div className="">
            <div className="  w-[100%] flex-col text-[25px] md:m-5 md:m-auto ">
              {LABEL__DATA.map((item, i) => (
                <SwiperSlide key={i}>
                  <div
                    className="h-[65vh] w-[100%] snap-start bg-white/[.1] max-[1200px]:h-[70vh] max-[768px]:h-[72vh]  max-[500px]:h-[80vh]"
                    id={item.id}
                    key={item.id}
                  >
