              ...
              <div className="sm:px-4 sm:px-8 md:px-20 md:px-8 lg:px-32">
                ...
                <div className="mt-16 grid justify-items-center">
                  <div className="mt-10 w-full px-4">
                    <div className="bg-white-800 rounded-3xl px-2 py-6 shadow-md">
                      <div className="flex flex-row">
                        <div className="w-full p-4 text-right">
                          <button className="btn rounded-full bg-slate-100 bg-opacity-25 px-3 py-1 text-xs text-white">
                            #Introduction
                          </button>
                          <h5 className="my-2 text-2xl font-medium tracking-tight text-white md:text-4xl">
                            Empowering
                          </h5>
                          <h5 className="mb-2 text-2xl font-medium tracking-tight text-violet-600 md:text-4xl">
